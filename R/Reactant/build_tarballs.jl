...
sources = [
   GitSource(repo, "9b96d3752dc58c5a61f7dd9fd40262a3b45032d2"),
...
for gpu in ("none", "cuda", "rocm"), mode in ("opt", "dbg"), cuda_version in ("none", "12.6", "12.8", "13.0"), rocm_version in ("none", "6.5", "7.0"), platform in platforms
